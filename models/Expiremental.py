...
class Expiremental(torch.nn.Module):

    def __init__(self, args):
        action_space = args.action_space
        hidden_state_sz = args.hidden_state_sz
        super(Expiremental, self).__init__()
        ...
        self.TFencoder = TransformerEncoder(200,512,512,512,512,[101,512],512,1024,8,4,0.2,use_bias=True)
